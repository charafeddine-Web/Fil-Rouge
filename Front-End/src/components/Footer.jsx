  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-100 pt-12 pb-8 font-urbanist">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 mb-6 max-w-md">
              ...
              while connecting with people heading in the same direction.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"
                className="h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-green-100 hover:text-green-500 transition-colors"
              >
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
                ...
                >
                  <path
                    ...
                    9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-
                    .443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"
                    clipRule="evenodd"
                  />
                </svg>
              </a>
        ...
        <div className="border-t border-gray-200 mt-12 pt-6 flex flex-col md:flex-row md:items-center md:justify-between text-sm text-gray-500">
          <p>&copy; {currentYear} EcoDrive. All rights reserved.</p>
