...
// const ChatifyChat = ({ contact, user }) => {
...
//         const response = await api.post('/chatify/fetchMessages', {
//           id: contact.id,
//         });
...
//     const channel = window.Echo.private('chatify');
...
//           api.post('/chatify/makeSeen', { id: contact.id })
...
//       await api.post('/chatify/sendMessage', {
//         id: contact.id,
//         type: 'user',
