      ...
      <div className="container mx-auto px-4 py-8 flex-grow max-w-5xl">
        ...
        <div className="space-y-6">
          {reservations[activeTab].map((reservation, index) => {
            // Extract trajet data for easier use
            ...
            const dateArrivee = trajet.date_arrivee || dateDepart; // Fallback to departure date if arrival date is not available
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="flex items-center text-sm text-gray-600 mb-4">
                        ...
                        <span>Passengers: {trajet.nombre_places || 1}</span>
                      </div>
